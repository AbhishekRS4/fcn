...
def batch_train(FLAGS):
    ...
    fcn = FCN(FLAGS.pretrained_weights, is_training, FLAGS.data_format, FLAGS.num_classes)
    fcn.vgg16_encoder(features)
    ...
    for epoch in range(FLAGS.num_epochs):
        ...
        print(f"training loss : {temp_train_loss_per_epoch / num_batches_train:.4f}, \
            ...
            validation accuracy : {temp_valid_acc_per_epoch:.4f}\n")
